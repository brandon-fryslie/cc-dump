...
_RELOAD_ORDER = [
    ...
    "surview.tui.event_handlers",  # depends on: formatting
    "surview.tui.widget_factory",  # depends on: rendering, panel_renderers
]
...
_RELOAD_IF_CHANGED = [
    ...
    "surview.store",
    "surview.router",
    "surview.db_queries",  # query layer for TUI panels
]
...
def init(package_dir: str) -> None:
    ...
    Args:
        package_dir: Path to the surview package directory (e.g., /path/to/src/surview)
    """
    _watch_dirs.clear()
