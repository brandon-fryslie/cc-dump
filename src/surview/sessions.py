...
def get_recordings_dir() -> str:
    ...
    Returns:
        Absolute path to ~/.local/share/surview/recordings/
    """
    return os.path.expanduser("~/.local/share/surview/recordings")
...
def list_recordings(recordings_dir: Optional[str] = None) -> list[dict]:
    ...
    Args:
        recordings_dir: Directory to search (default: ~/.local/share/surview/recordings)
